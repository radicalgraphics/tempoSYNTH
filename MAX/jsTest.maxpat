...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 1920.021768707480078, "ticks" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-2",
					"items" : [ "BD0010.WAV", ",", "Clap.WAV", ",", "Claves.WAV", ",", "ClHat.WAV", ",", "commandParser.js", ",", "CY1010.WAV", ",", "jsTest.maxpat", ",", "OSC max.maxpat", ",", "PodCastRoughDraft.wav", ",", "polybuffer~.help.maxpat", ",", "polybuffer~.maxpat", ",", "test.js" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "C:/Users/Patron/Documents/GitHub/tempoSYNTH/MAX/"
				}
