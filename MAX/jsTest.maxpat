...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 729.0, 414.0, 52.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 513.0, 133.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 651.0, 95.0, 23.0 ],
					"text" : "prepend types"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 71.0, 619.0, 160.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.5, 568.0, 120.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.125, 556.25, 134.75, 44.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-8",
					"items" : [ "BD0010.WAV", ",", "Clap.WAV", ",", "Claves.WAV", ",", "ClHat.WAV", ",", "CY1010.WAV", ",", "PodCastRoughDraft.wav" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 763.0, 130.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 513.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 11.0, 718.0, 130.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 430.333343505859375, 580.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 430.333343505859375, 734.5, 24.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 430.5, 810.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.5, 734.5, 85.0, 22.0 ],
					"text" : "prepend open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 430.5, 771.4285888671875, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 239.999999999999659, "ticks" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-2",
					"items" : [ "BD0010.WAV", ",", "Clap.WAV", ",", "Claves.WAV", ",", "ClHat.WAV", ",", "commandParser.js", ",", "CY1010.WAV", ",", "jsTest.maxpat", ",", "OSC max.maxpat", ",", "polybuffer~.help.maxpat", ",", "polybuffer~.maxpat", ",", "test.js" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "APPLE SSD SM0512L:/Users/weiqi/Documents/GitHub/tempoSYNTH/MAX/"
				}
